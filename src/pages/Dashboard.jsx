  ...
  const laadGrafieken = useCallback(async () => {
    ...
    try {
      ...
      setOmzetData(Object.values(som).some(v => v > 0) ? {
        ...
        datasets: [{ label: 'Omzet incl. BTW', data: maanden.map(m => Math.round(som[m.key])), backgroundColor: '#22C35D', borderRadius: 6, borderSkipped: false }],
      } : null)
        ...
        <div className="flex flex-col items-center justify-center py-16 text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 w-full max-w-2xl">
            {[
              ...
              { label: 'Instellingen invullen',   icon: Settings,  to: '/instellingen', kleur: '#22C35D', bg: '#f0fdf4' },
    ...
    <PageWrapper title="" description="">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
          {[
            ...
            <button key={label} onClick={() => navigate(to)}
              className="flex flex-col items-center gap-2 px-3 py-4 rounded-xl border border-gray-200 bg-white text-xs font-medium text-gray-600 hover:border-[#22C35D] hover:text-[#17A84B] hover:bg-[#22C35D]/5 transition-colors cursor-pointer">
              <Icon size={18} />
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-50">
          ...
          <Link to="/projecten" className="text-xs text-[#22C35D] hover:underline font-medium">Alle projecten →</Link>
        </div>
                ...
                {recenteProj.map(p => (
                  <tr key={p.id} className="hover:bg-gray-50/60 transition-colors">
                    <td className="px-6 py-3 font-medium text-gray-800">
                      <Link to={`/projecten/${p.id}`} className="hover:text-[#17A84B] transition-colors">{p.naam}</Link>
                    </td>
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-50">
          ...
          <Link to="/offertes" className="text-xs text-[#22C35D] hover:underline font-medium">Alle offertes →</Link>
        </div>
                  ...
                  return (
                    <tr key={o.id} className="hover:bg-gray-50/60 transition-colors">
                      <td className="px-6 py-3 font-mono text-xs font-semibold text-gray-700">
                        <Link to={`/offertes/${o.id}`} className="hover:text-[#17A84B] transition-colors">{o.nummer ?? '—'}</Link>
                      </td>
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-50">
          ...
          <button onClick={() => navigate('/projecten')} className="text-xs text-[#22C35D] hover:underline font-medium">
                  ...
                  return (
                    <tr key={m.id} className="hover:bg-gray-50/60 transition-colors">
                      ...
                      <td className="px-3 py-3">
                        {m.projecten ? <Link to={`/projecten/${m.projecten.id}`} className="text-gray-700 font-medium hover:text-[#17A84B] transition-colors">{m.projecten.naam}</Link> : <span className="text-gray-400">—</span>}
                      </td>
