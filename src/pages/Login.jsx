  ...
  return (
    <div className="min-h-screen flex" style={{ background: '#0B0F0E' }}>
      ...
      <div className="hidden lg:flex flex-col justify-between w-2/5 p-12"
        ...
        <div>
          <div className="mb-8">
            <img src="/assets/logo/studio-byt-logo-negative.svg" alt="Build Your Tools" style={{ height: 300, objectFit: 'contain', maxWidth: '100%' }} />
          </div>
      ...
      <div className="flex-1 flex items-center justify-center px-6">
        <div className="w-full max-w-sm">
          ...
          <div className="lg:hidden mb-10 flex justify-start">
            <img src="/assets/logo/studio-byt-logo-negative.svg" alt="Build Your Tools" style={{ height: 120, objectFit: 'contain', maxWidth: '100%' }} />
          </div>
